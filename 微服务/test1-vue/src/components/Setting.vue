			...
			<div class="setting-container">
					...
					<div   class="right-content">
						<div   class="label-one" id="label-one">
							...
							<div style='width:150px;'>
                                ...
                                action="http://localhost:8002/userSetting/upload"
                                :show-file-list="false"
                                :on-success="handleAvatarSuccess"
                                :before-upload="beforeAvatarUpload">
                                <img v-if="fileId" :src="fileId" width="170px">
                                </el-upload>
                            </div>
							<div   class="nick-name">
								昵称
							</div>
							<div   class="input-wrap"><input v-model="newNickName" type="text" maxlength="15" placeholder="请输入您的昵称" class="nick-input" clearable> <em   class="error" style="display: none;"></em>
								<div   class="clear"></div>
							</div> 
                ...
                <el-dialog title="修改密码" :visible.sync="dialogFormVisible">
                    <!-- <el-form :model="form"> -->
                        ...
                        <el-input v-model="oldPwd" type="text"></el-input>
                        </el-form-item>
...
export default {
        ...
        if(token != null || token != ""){
            ...
            .then( (result)=>{
                if(result.data.state == 4){
                    ...
                    this.fileId = this.user.portrait;
    ...
    methods: {
        ...
        //修改密码
        updatePwd(){
           if(this.oldPwd == this.newPwd1){// 获取当前用户的密码与新密码进行匹配
                this.$message.warning("新密码与当前密码一样，请更换密码！");
                return;
            }
               if(this.newPwd1 == this.newPwd2){ // 新密码和确认密码进行验证相等
